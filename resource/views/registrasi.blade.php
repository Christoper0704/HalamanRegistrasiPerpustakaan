...
<nav class="navbar navbar-expand-sm navbar-light" style="background-color: #34BE82;">
  <div class="container-fluid">
    <ul class="navbar-nav">
    <a class="navbar-brand" href="#"><img src="{{url('/images/book.png')}}" alt="Avatar Logo" style="width:40px;" class="rounded-pill"></a>
      <li class="nav-item">
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      <div class="col-lg-8 col-xl-6">
        <div class="card rounded-3">
          <img src="{{url('/images/library.jpg')}}" class="w-100" style="border-top-left-radius: .3rem; border-top-right-radius: .3rem;" alt="Libary">
          <div class="card-body p-4 p-md-5">
            ...
            <form class="px-md-2 needs-validation">
              ...
              <div class="form-outline mb-4">
                ...
                <input type="password" id="pass" placeholder="Masukkan Password Anda" class="form-control" required>
              </div>
